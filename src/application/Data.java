...
/**
 * Class consisting of various functions pertaining to the system, including JSON readers/writers, file locations, etc.
 * @author Tealeaf
 *
 */
public class Data {
	...
	/**
	 * A {@code JSON} reader and writer that reads and writes static variables as well as non-static variables
	 */
	 ...
	 * 
	 * <br><br> The base directory, when used here, describes the directory of the %appdata% location for this specific app, regardless of OS
	 * @param path An array of strings representing the path an object takes from the base directory.
	 * <br>All the strings in the array are folders nested into eachother, except for the very last one which is the file
	 * <br>For example, inputting {@code {"Data","File.txt"}} will return in the {@code path + "\Data\File.txt"}
	 ...
	 * Returns the {@code File} depending on it's path in relation to the base directory
	 * 
	 * <br><br> The base directory, when used here, describes the directory of the {@code %appdata%} location for this specific app, regardless of OS
